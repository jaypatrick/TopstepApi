...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    public virtual async System.Threading.Tasks.Task<AccountResponse<SearchAccountResponse>> SearchAccountsAsync(SearchAccountRequest request, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (request == null)
            ...
            using (var request_ = new System.Net.Http.HttpRequestMessage())
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        ...
                        return new AccountResponse<SearchAccountResponse>(status_, headers_, objectResponse_.Object);
                    }
                    else
                    {
