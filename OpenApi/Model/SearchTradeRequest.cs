...
namespace OpenApi.Model
{
    ...
    public partial class SearchTradeRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SearchTradeRequest(int accountId, Option<DateTimeOffset?> startTimestamp = default, Option<DateTimeOffset?> endTimestamp = default)
        {
            AccountId = accountId;
        ...
        public Option<DateTimeOffset?> StartTimestampOption { get; private set; }

        /// <summary>
        /// Gets or Sets StartTimestamp
        /// </summary>
        [JsonPropertyName("startTimestamp")]
        public DateTimeOffset? StartTimestamp { get { return this.StartTimestampOption; } set { this.StartTimestampOption = new(value); } }
