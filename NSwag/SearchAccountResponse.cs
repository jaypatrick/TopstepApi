...
public partial record SearchAccountResponse
{
    ...
    public SearchAccountErrorCode ErrorCode { get; init; }
    ...
    public System.Collections.Generic.ICollection<TradingAccountModel>? Accounts { get; init; }
