...
inputSpec: TopstepClient.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{A8E756D4-E237-4587-9832-021DEFB9E252}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IAccountSearchAccountsApiResponse apiResponse = await api.AccountSearchAccountsAsync("todo");
            SearchAccountResponse? model = apiResponse.Ok();
        }
...
## Api Information
- appName: ProjectX Gateway API
- appVersion: 1.0.0
- appDescription: ProjectX Gateway API Documentation and specification.
